...
{
  ur_dashboard_msgs__srv__Popup_Request * msg = (ur_dashboard_msgs__srv__Popup_Request *)malloc(sizeof(ur_dashboard_msgs__srv__Popup_Request));
  if (!msg) {
    return NULL;
  }
...
ur_dashboard_msgs__srv__Popup_Request__Sequence__init(ur_dashboard_msgs__srv__Popup_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ur_dashboard_msgs__srv__Popup_Request *)calloc(size, sizeof(ur_dashboard_msgs__srv__Popup_Request));
    if (!data) {
      return false;
    }
...
{
  ur_dashboard_msgs__srv__Popup_Request__Sequence * array = (ur_dashboard_msgs__srv__Popup_Request__Sequence *)malloc(sizeof(ur_dashboard_msgs__srv__Popup_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  ur_dashboard_msgs__srv__Popup_Response * msg = (ur_dashboard_msgs__srv__Popup_Response *)malloc(sizeof(ur_dashboard_msgs__srv__Popup_Response));
  if (!msg) {
    return NULL;
  }
...
ur_dashboard_msgs__srv__Popup_Response__Sequence__init(ur_dashboard_msgs__srv__Popup_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ur_dashboard_msgs__srv__Popup_Response *)calloc(size, sizeof(ur_dashboard_msgs__srv__Popup_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  ur_dashboard_msgs__srv__Popup_Response__Sequence * array = (ur_dashboard_msgs__srv__Popup_Response__Sequence *)malloc(sizeof(ur_dashboard_msgs__srv__Popup_Response__Sequence));
  if (!array) {
    return NULL;
  }
