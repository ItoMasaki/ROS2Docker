...
static size_t _Load_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ur_dashboard_msgs__srv__Load_Request(
    full_bounded, 0);
}
...
static size_t _Load_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ur_dashboard_msgs__srv__Load_Response(
    full_bounded, 0);
}
