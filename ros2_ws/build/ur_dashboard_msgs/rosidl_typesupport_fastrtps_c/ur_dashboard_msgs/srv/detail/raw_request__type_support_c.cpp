...
static size_t _RawRequest_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ur_dashboard_msgs__srv__RawRequest_Request(
    full_bounded, 0);
}
...
static size_t _RawRequest_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ur_dashboard_msgs__srv__RawRequest_Response(
    full_bounded, 0);
}
