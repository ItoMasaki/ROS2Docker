...
static size_t _IsProgramRunning_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ur_dashboard_msgs__srv__IsProgramRunning_Request(
    full_bounded, 0);
}
...
static size_t _IsProgramRunning_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ur_dashboard_msgs__srv__IsProgramRunning_Response(
    full_bounded, 0);
}
