...
static size_t _GetProgramState_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ur_dashboard_msgs__srv__GetProgramState_Request(
    full_bounded, 0);
}
...
static size_t _GetProgramState_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ur_dashboard_msgs__srv__GetProgramState_Response(
    full_bounded, 0);
}
