...
void GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_init_function(
...
void GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_fini_function(void * message_memory)
{
  ur_dashboard_msgs__srv__GetLoadedProgram_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_message_members = {
  ...
  GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_message_member_array,  // message members
  GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_message_type_support_handle = {
  0,
  &GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur_dashboard_msgs, srv, GetLoadedProgram_Request)() {
  if (!GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_message_type_support_handle.typesupport_identifier) {
    GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetLoadedProgram_Request__rosidl_typesupport_introspection_c__GetLoadedProgram_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_fini_function(void * message_memory)
{
  ur_dashboard_msgs__srv__GetLoadedProgram_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_message_member_array[3] = {
  {
    "answer",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_message_members = {
  "ur_dashboard_msgs__srv",  // message namespace
  "GetLoadedProgram_Response",  // message name
  3,  // number of fields
  sizeof(ur_dashboard_msgs__srv__GetLoadedProgram_Response),
  GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_message_member_array,  // message members
  GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_message_type_support_handle = {
  0,
  &GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur_dashboard_msgs, srv, GetLoadedProgram_Response)() {
  if (!GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_message_type_support_handle.typesupport_identifier) {
    GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetLoadedProgram_Response__rosidl_typesupport_introspection_c__GetLoadedProgram_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
