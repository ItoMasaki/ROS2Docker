...
static const _SmachContainerStructure_type_support_symbol_names_t _SmachContainerStructure_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smach_msgs, msg, SmachContainerStructure)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smach_msgs, msg, SmachContainerStructure)),
  }
};
...
{
  return &::smach_msgs::msg::rosidl_typesupport_cpp::SmachContainerStructure_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smach_msgs, msg, SmachContainerStructure)() {
  return get_message_type_support_handle<smach_msgs::msg::SmachContainerStructure>();
}
