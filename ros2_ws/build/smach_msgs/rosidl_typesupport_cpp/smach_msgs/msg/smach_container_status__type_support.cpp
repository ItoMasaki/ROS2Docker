...
static const _SmachContainerStatus_type_support_symbol_names_t _SmachContainerStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smach_msgs, msg, SmachContainerStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smach_msgs, msg, SmachContainerStatus)),
  }
};
...
{
  return &::smach_msgs::msg::rosidl_typesupport_cpp::SmachContainerStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smach_msgs, msg, SmachContainerStatus)() {
  return get_message_type_support_handle<smach_msgs::msg::SmachContainerStatus>();
}
