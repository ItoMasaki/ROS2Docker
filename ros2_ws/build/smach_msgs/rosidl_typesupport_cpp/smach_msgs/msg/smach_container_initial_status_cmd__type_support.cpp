...
static const _SmachContainerInitialStatusCmd_type_support_symbol_names_t _SmachContainerInitialStatusCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smach_msgs, msg, SmachContainerInitialStatusCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smach_msgs, msg, SmachContainerInitialStatusCmd)),
  }
};
...
{
  return &::smach_msgs::msg::rosidl_typesupport_cpp::SmachContainerInitialStatusCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smach_msgs, msg, SmachContainerInitialStatusCmd)() {
  return get_message_type_support_handle<smach_msgs::msg::SmachContainerInitialStatusCmd>();
}
