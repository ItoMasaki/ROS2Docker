...
bool ur_dashboard_msgs__msg__program_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_dashboard_msgs.msg._program_state.ProgramState", full_classname_dest, 49) == 0);
  }
  ur_dashboard_msgs__msg__ProgramState * ros_message = _ros_message;
  {  // state
...
{
  /* NOTE(esteve): Call constructor of ProgramState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ur_dashboard_msgs.msg._program_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ProgramState");
