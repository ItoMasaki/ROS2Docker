...
static rosidl_typesupport_introspection_c__MessageMember ToolDataMsg__rosidl_typesupport_introspection_c__ToolDataMsg_message_member_array[9] = {
  {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ur_msgs__msg__ToolDataMsg, tool_voltage_48v),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
